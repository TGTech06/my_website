                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Wrap(
                                      ...
                                      runSpacing: 40.0,
                                      children: [
                                        getColumn('QR Code Business Card', 'This is my most successful app with currently over 1K downloads a month. The app allows users to share contact details via a QR Code. In my opinion it is the most useful app I have made and I use it myself all the time. It is very convenient because it is extremely fast and easy to use. It also removes the chance of error while giving contact details and the contact is saved directly into their phone.', 'https://tommasogiovannini.wixsite.com/qrbusinesscard', 'https://apps.apple.com/us/app/qr-code-business-card/id1563633717', 'https://play.google.com/store/apps/details?id=com.tommasogiovannini.qr_code_maker'),
                                        getColumn('Revision Flashcards', 'I always use this app when studying now. It makes it fast and easy to create flashcards to help you study more effectively. In a recent update I added a feature which allows you to have your flashcards read out loud and you can have it loop through all the flashcards. The app also makes it easy to keep track of your progress as you study. Recently, I made a website (www.revisionflashcards.com) to allow users to edit their flashcards from a desktop.', 'https://tommasogiovannini.wixsite.com/revisionflashcards', 'https://apps.apple.com/us/app/revision-flashcards/id1562363345', 'https://play.google.com/store/apps/details?id=com.tommasogiovannini.flashcards'),
                                        getColumn('ConcentratedTomato Focus Timer', 'This was my first app. I made it during the first covid lockdown to help students keep focused working from home. It uses the pomodoro technique where you work for 25 minutes and then have a 5 minute break. This is to help you stay focused and work at your best without getting burnt out.', 'https://tommasogiovannini.wixsite.com/concentratedtomato', 'https://apps.apple.com/us/app/concentratedtomato-focus-timer/id1504771089?ls=1', 'https://play.google.com/store/apps/details?id=com.tommasogiovannini.concentratedtomato'),
                                        // SizedBox(width: 20,),
                                        getColumn('Daily Habits Tracker', 'The app allows users to set daily habits and it keeps a streak of how many days in a row you have managed to achieve your goals. There are a lot of similar apps out there but the main advantage of Daily Habits Tracker is its simplicity. I believe ease of use is one of the most important qualities for this type of app as people need to use it every day. There are also sound effects to keep users motivated and boost dopamine.', 'https://tommasogiovannini.wixsite.com/daily-habits-tracker', 'https://apps.apple.com/us/app/daily-habits-tracker/id1571038894', 'https://play.google.com/store/apps/details?id=com.tommasogiovannini.habittracker.daily_habit_tracker'),
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 20,),
                                              getColumn('Kaggle', 'I have a taken part in some Kaggle competitions and have finished in the top 20% twice. This was probably one of the most challenging things I have done. I learnt a lot more advanced maths, primarily statistics and I also got a chance to really delve into Python. I used Tensorflow and Keras to make the machine learning algorithms and it was a really rewarding project. Some models I trained from scratch while others I tweaked various existing models.', 'https://www.kaggle.com/tommasogiovannini', '', ''),
